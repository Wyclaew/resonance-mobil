...
const tr = {
  ...
  "profile.avatarTooBig": "Fotoğraf çok büyük (en fazla 8 MB).",
  ...
  "wrapped.storyWatch": "Hikâye olarak izle",
  "wrapped.storyIntro": "{year} yılında",
  "wrapped.storyMinutes": "{minutes} dakika müzik",
  "wrapped.storyHours": "Yaklaşık {hours} saat · {plays} çalma",
  "wrapped.storyArtistsKicker": "Kaç sanatçı dinledin",
  "wrapped.storyArtistsSub": "{newArtists} tanesiyle bu yıl tanıştın",
  "wrapped.storyTracksKicker": "Yılın şarkısı",
  "wrapped.storyPlays": "{n} çalma",
  "wrapped.storyHabitKicker": "Dinleme alışkanlığın",
  "wrapped.storyPeakHour": "En çok saat {hour} civarı",
  "wrapped.storyStreak": "En uzun serin {n} gün",
  "wrapped.storyRecKicker": "Resonance sana kaç şarkı önerdi",
  "wrapped.storyRecSub": "{accepted} tanesini dinledin · {genres} yeni tür",
  "wrapped.storyOpen": "{year} özetini aç",
  "wrapped.storyReady": "{year} özetin hazır — bir bakmak ister misin?",
  ...
  "common.save": "Kaydet",
  "remote.applied": "Telefondan komut alındı.",
  "profile.avatarEdit": "Profil fotoğrafı",
  "profile.avatarEditHelp": "Sürükleyerek konumlandır, kaydıracı ile yakınlaştır.",
  "profile.avatarReposition": "Fotoğrafı düzenle",
  "common.loading": "Yükleniyor…",
  "playlist.removedOne": "{title} listeden çıkarıldı.",
  "playlist.folder": "Klasör",
  "playlist.folderNone": "Klasörsüz",
  "playlist.folderNew": "Yeni klasör adı",
  "common.add": "Ekle",
  "playlist.sortTitle": "Sıralama",
  "playlist.sortManualShort": "Sıra",
  "playlist.sortTitleAz": "Şarkı adı (A-Z)",
  "playlist.sortArtistAz": "Sanatçı (A-Z)",
  "playlist.sortAddedNew": "Eklenme (yeni → eski)",
  "playlist.sortAddedOld": "Eklenme (eski → yeni)",
  "playlist.sortDuration": "Süre (uzun → kısa)",
  "playlist.sortNote": "Sıralama yalnız görünümü değiştirir; listenin kendi sırası bozulmaz. Çıkış tarihi YouTube parçalarında bilinmiyor.",
  "playlist.selectMode": "Seç",
  "playlist.selectedCount": "{n} seçili",
  "playlist.selectAll": "Tümünü seç",
  "playlist.selectClear": "Seçimi bırak",
  "playlist.selectedRemove": "Listeden çıkar",
  "playlist.selectedDownload": "İndir",
  "playlist.selectedAdd": "Listeye ekle",
  "playlist.selectedRemoved": "{n} şarkı listeden çıkarıldı.",
  "playlist.selectedAdded": "{n} şarkı {name} listesine eklendi.",
  "smart.discoverWeek": "Haftalık Keşif",
  "smart.discoverWeekDesc": "Her pazartesi yenilenen 30 yeni şarkı",
  "sync.ownTitle": "Sunucu (Supabase projesi)",
  "sync.ownDefault": "Varsayılan",
  "sync.ownYours": "Kendi projen",
  "sync.ownBody": "Senkron için kendi ücretsiz Supabase projeni kullanabilirsin. Verdiğin adres ve anahtar uygulamayla gelen varsayılanın yerine geçer; oturumun kapatılır ve yeni projede yeniden giriş yaparsın.",
  "sync.ownKeyPlaceholder": "anon / public anahtarı",
  "sync.ownSave": "Kaydet ve çık",
  "sync.ownReset": "Varsayılana dön",
  "sync.ownSaved": "Kendi projen ayarlandı — şimdi giriş yap.",
  "sync.ownCleared": "Varsayılan projeye dönüldü.",
  "sync.ownSteps": "Adımlar: supabase.com'da ücretsiz proje aç → SQL Editor'de depodaki docs/supabase-schema.sql dosyasını çalıştır → Project Settings → API'den Project URL ve anon anahtarını buraya yapıştır.",
  "playlist.totalMinutes": "{n} dk",
  "playlist.downloadedCount": "{n} indirilmiş",
  "sync.healthTitle": "Senkron sağlığı",
  "sync.healthBody": "Tablo başına bu cihazdaki ve buluttaki satır sayısı. Sayılar tutmuyorsa bir şey eksik demektir; \"Onar\" iki yönde de baştan bir tur atar.",
  "sync.healthTable": "Tablo",
  "sync.healthLocal": "Burada",
  "sync.healthCloud": "Bulutta",
  "sync.healthOk": "Tutuyor",
  "sync.healthDiff": "{n} tabloda fark",
  "sync.healthRefresh": "Yeniden say",
  "sync.healthRepair": "Onar",
  "sync.healthRepairHint": "Baştan tam tur; birkaç dakika sürebilir.",
  "sync.backupTitle": "Buluta yedek",
  "sync.backupBody": "Listelerin, oyların ve parça bilgilerin haftada bir buluta yazılır (son 5 yedek saklanır). Uygulamanın kendi klasörü silinse bile buradan geri alınır.",
  "sync.backupNow": "Şimdi yedekle",
  "sync.backupAuto": "Haftada bir kendiliğinden yazılır.",
  "sync.backupEmpty": "Henüz bulut yedeği yok.",
  "sync.backupRestore": "Geri yükle",
  "sync.backupRestoreConfirm": "Emin misin?",
  "sync.backupDone": "Yedek buluta yazıldı.",
  "sync.backupRestored": "Geri yüklendi: {tracks} parça, {playlists} liste.",
  "sync.backupSummary": "{tracks} parça · {playlists} liste · {mb} MB",
  "common.close": "Kapat",
...
const en: Record<TrKey, string> = {
  ...
  "profile.avatarTooBig": "Image too large (8 MB max).",
  ...
  "wrapped.storyWatch": "Watch as a story",
  "wrapped.storyIntro": "In {year}",
  "wrapped.storyMinutes": "{minutes} minutes of music",
  "wrapped.storyHours": "About {hours} hours · {plays} plays",
  "wrapped.storyArtistsKicker": "Artists you listened to",
  "wrapped.storyArtistsSub": "You met {newArtists} of them this year",
  "wrapped.storyTracksKicker": "Song of the year",
  "wrapped.storyPlays": "{n} plays",
  "wrapped.storyHabitKicker": "Your listening habit",
  "wrapped.storyPeakHour": "Mostly around {hour}:00",
  "wrapped.storyStreak": "Longest streak: {n} days",
  "wrapped.storyRecKicker": "Songs Resonance suggested",
  "wrapped.storyRecSub": "You played {accepted} of them · {genres} new genres",
  "wrapped.storyOpen": "Open your {year} recap",
  "wrapped.storyReady": "Your {year} recap is ready — want a look?",
  ...
  "common.save": "Save",
  "remote.applied": "Command received from your phone.",
  "profile.avatarEdit": "Profile photo",
  "profile.avatarEditHelp": "Drag to position, use the slider to zoom.",
  "profile.avatarReposition": "Edit photo",
  "common.loading": "Loading…",
  "playlist.removedOne": "{title} removed from the playlist.",
  "playlist.folder": "Folder",
  "playlist.folderNone": "No folder",
  "playlist.folderNew": "New folder name",
  "common.add": "Add",
  "playlist.sortTitle": "Sort",
  "playlist.sortManualShort": "Order",
  "playlist.sortTitleAz": "Title (A-Z)",
  "playlist.sortArtistAz": "Artist (A-Z)",
  "playlist.sortAddedNew": "Added (new → old)",
  "playlist.sortAddedOld": "Added (old → new)",
  "playlist.sortDuration": "Length (long → short)",
  "playlist.sortNote": "Sorting only changes the view; the playlist keeps its own order. Release date is unknown for YouTube tracks.",
  "playlist.selectMode": "Select",
  "playlist.selectedCount": "{n} selected",
  "playlist.selectAll": "Select all",
  "playlist.selectClear": "Clear selection",
  "playlist.selectedRemove": "Remove from playlist",
  "playlist.selectedDownload": "Download",
  "playlist.selectedAdd": "Add to playlist",
  "playlist.selectedRemoved": "{n} tracks removed from the playlist.",
  "playlist.selectedAdded": "{n} tracks added to {name}.",
  "smart.discoverWeek": "Discover Weekly",
  "smart.discoverWeekDesc": "30 new songs, refreshed every Monday",
  "sync.ownTitle": "Server (Supabase project)",
  "sync.ownDefault": "Default",
  "sync.ownYours": "Your project",
  "sync.ownBody": "You can sync through your own free Supabase project. The address and key you enter replace the ones shipped with the app; you are signed out and sign in again on the new project.",
  "sync.ownKeyPlaceholder": "anon / public key",
  "sync.ownSave": "Save and sign out",
  "sync.ownReset": "Back to default",
  "sync.ownSaved": "Your project is set — sign in now.",
  "sync.ownCleared": "Back to the default project.",
  "sync.ownSteps": "Steps: create a free project at supabase.com → run docs/supabase-schema.sql from the repo in the SQL Editor → paste the Project URL and anon key from Project Settings → API.",
  "playlist.totalMinutes": "{n} min",
  "playlist.downloadedCount": "{n} downloaded",
  "sync.healthTitle": "Sync health",
  "sync.healthBody": "Row counts on this device and in the cloud, per table. If they differ something is missing; \"Repair\" runs a full pass in both directions.",
  "sync.healthTable": "Table",
  "sync.healthLocal": "Here",
  "sync.healthCloud": "Cloud",
  "sync.healthOk": "Matching",
  "sync.healthDiff": "{n} tables differ",
  "sync.healthRefresh": "Count again",
  "sync.healthRepair": "Repair",
  "sync.healthRepairHint": "Full pass from scratch; can take a few minutes.",
  "sync.backupTitle": "Cloud backup",
  "sync.backupBody": "Your playlists, votes and track data are written to the cloud weekly (last 5 kept). They survive even if the app folder is deleted.",
  "sync.backupNow": "Back up now",
  "sync.backupAuto": "Written automatically once a week.",
  "sync.backupEmpty": "No cloud backup yet.",
  "sync.backupRestore": "Restore",
  "sync.backupRestoreConfirm": "Are you sure?",
  "sync.backupDone": "Backup written to the cloud.",
  "sync.backupRestored": "Restored: {tracks} tracks, {playlists} playlists.",
  "sync.backupSummary": "{tracks} tracks · {playlists} playlists · {mb} MB",
  "common.close": "Close",
  "common.clear": "Clear",

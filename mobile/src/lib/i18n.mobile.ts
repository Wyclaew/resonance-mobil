...
const mtr = {
  ...
  "m.discover.saved": "Kaldığın keşif",
  "m.discover.savedMeta": "{n} şarkı sırada · {ago}",
  "m.discover.resume": "Keşfe devam et",
  "m.discover.newBatch": "Yeni keşif",
  "m.discover.savedHint": "Başka bir şey çalınca keşfin burada bekler; dönünce kaldığın şarkıdan sürer.",
  "m.home.discoverySaved": "Kaldığın keşif: {title}",
  ...
  "m.dl.waitingNetwork": "Bağlantı bekleniyor — gelince kaldığı yerden sürer",
  "m.downloads.queue": "İndirme kuyruğu · {n}",
  "m.downloads.queued": "Sırada",
  "m.player.offline": "Bağlantı yok — gelince bu şarkıdan devam edecek",
  "m.player.offlineJump": "Bağlantı yok — sıradaki indirilmiş şarkıya geçildi",
  "m.track.pending": "Bilgisi alınıyor…",
  ...
  "m.update.title": "Yeni sürüm var",
  "m.update.body": "Resonance {version} yayınlandı (şu an {current}).",
  "m.update.size": "{size} indirilecek",
  "m.update.notes": "Bu sürümde",
  "m.update.download": "İndir ve kur",
  "m.update.later": "Sonra",
  "m.update.skip": "Bu sürümü atla",
  "m.update.downloading": "İndiriliyor",
  "m.update.install": "Kurulum ekranı açılıyor…",
  "m.update.failed": "İndirilemedi",
  "m.update.installHint": "Android ilk kez \"bu uygulamadan kuruluma izin ver\" diye sorabilir; izin verince kurulum ekranı açılır. Veriler yerinde kalır.",
  "m.update.check": "Güncellemeleri denetle",
  "m.update.checking": "Bakılıyor…",
  "m.update.upToDate": "En güncel sürümdesin ({version})",
  "m.common.info": "Açıklamayı göster",
  "m.dl.retrySoon": "birazdan yeniden denenecek",
  "m.dl.noVersion": "Bu kayıt indirilemiyor ({why}) ve doğrulanmış başka sürüm bulunamadı",
  "m.dl.why.bot": "YouTube bot doğrulaması istedi",
  "m.dl.why.age": "yaş sınırlı",
  "m.dl.why.login": "YouTube bu kayıt için oturum istiyor",
  "m.dl.why.private": "video gizli",
  "m.dl.why.region": "bu bölgede kapalı",
  "m.dl.why.removed": "video kaldırılmış",
  "m.dl.why.unplayable": "YouTube'da kullanılamıyor",
  "m.version.pick": "Sürüm seç",
  "m.version.title": "Sürüm seç",
  "m.version.hint":
    "Aynı şarkının YouTube'daki yüklemeleri. Seçtiğin sürüm denenir, çalıyorsa bu parçaya bağlanır ve senkronla diğer cihazlarına da geçer.",
  "m.version.match": "eşleşiyor",
  "m.version.current": "şu anki",
  "m.version.failed": "çalınamıyor",
  "m.version.done": "Sürüm değiştirildi",
  "m.version.doneDownload": "Sürüm değiştirildi — indiriliyor",
  "m.version.empty": "Sonuç yok — aramayı değiştir",
  "m.version.searchFailed": "Aranamadı",
  "m.version.sheetAction": "Başka sürüm seç",
  "m.version.sheetActionSub": "Yanlış şarkı çalıyor ya da inmiyorsa",
...
const men: Record<MKey, string> = {
  ...
  "m.discover.saved": "Your paused discovery",
  "m.discover.savedMeta": "{n} songs queued · {ago}",
  "m.discover.resume": "Resume discovery",
  "m.discover.newBatch": "New discovery",
  "m.discover.savedHint": "When you play something else, your discovery waits here and picks up from the same song.",
  "m.home.discoverySaved": "Paused discovery: {title}",
  ...
  "m.dl.waitingNetwork": "Waiting for a connection — resumes where it stopped",
  "m.downloads.queue": "Download queue · {n}",
  "m.downloads.queued": "Queued",
  "m.player.offline": "No connection — this song resumes when you're back online",
  "m.player.offlineJump": "No connection — skipped to the next downloaded song",
  "m.track.pending": "Fetching info…",
  ...
  "m.update.title": "Update available",
  "m.update.body": "Resonance {version} is out (you have {current}).",
  "m.update.size": "{size} to download",
  "m.update.notes": "In this release",
  "m.update.download": "Download & install",
  "m.update.later": "Later",
  "m.update.skip": "Skip this version",
  "m.update.downloading": "Downloading",
  "m.update.install": "Opening the installer…",
  "m.update.failed": "Download failed",
  "m.update.installHint": "Android may first ask you to allow installs from this app; after that the installer opens. Your data stays.",
  "m.update.check": "Check for updates",
  "m.update.checking": "Checking…",
  "m.update.upToDate": "You're on the latest version ({version})",
  "m.common.info": "Show explanation",
  "m.dl.retrySoon": "retrying shortly",
  "m.dl.noVersion": "This upload can't be downloaded ({why}) and no verified alternative was found",
  "m.dl.why.bot": "YouTube asked for a bot check",
  "m.dl.why.age": "age-restricted",
  "m.dl.why.login": "YouTube requires sign-in for this upload",
  "m.dl.why.private": "the video is private",
  "m.dl.why.region": "blocked in this region",
  "m.dl.why.removed": "the video was removed",
  "m.dl.why.unplayable": "unavailable on YouTube",
  "m.version.pick": "Pick version",
  "m.version.title": "Pick a version",
  "m.version.hint":
    "Uploads of the same song on YouTube. The one you pick is tested first; if it plays, it's linked to this track and syncs to your other devices.",
  "m.version.match": "match",
  "m.version.current": "current",
  "m.version.failed": "not playable",
  "m.version.done": "Version changed",
  "m.version.doneDownload": "Version changed — downloading",
  "m.version.empty": "No results — try another search",
  "m.version.searchFailed": "Search failed",
  "m.version.sheetAction": "Pick another version",
  "m.version.sheetActionSub": "If it plays the wrong song or won't download",
